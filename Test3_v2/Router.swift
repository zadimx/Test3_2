...
//            guard let mainCollectionViewController = assemblyBuilder?.createMainMainModule(router: self) else { return }
//            splitViewController?.showDetailViewController(mainCollectionViewController, sender: nil)
